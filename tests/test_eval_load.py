...
MINI_SCHEMA = {
    "name": "mini",
    "entities": [
        {"label": "Team", "properties": {"inception_year": "int", "owners": "list[str]"}},
        {"label": "Player", "properties": {"height_cm": "float", "date_of_birth": "date"}},
        {"label": "Person", "properties": {}},
    ],
    "relations": [
        {"label": "playsFor", "subj_label": "Player", "obj_label": "Team", "properties": {"start_year": "int"}},
        {"label": "mentors", "subj_label": "Person", "obj_label": "Person", "properties": {}},
    ],
}
...
MINI_KG = {
    "schema": MINI_SCHEMA,
    "entities": [
        {"eid": "Team#Q1", "label": "Team", "name": "Lakers",
         "properties": {"inception_year": 1946, "owners": ["Jeanie Buss"]}},
        {"eid": "Player#Q2", "label": "Player", "name": "LeBron James",
         "properties": {"height_cm": 206.0, "date_of_birth": "1984-12-30"}},
        {"eid": "Player#Q3", "label": "Player", "name": "Nikola Jokic",
         "properties": {"height_cm": 211.0, "date_of_birth": None}},
    ],
    "relations": [
        {"rid": "0", "label": "playsFor", "subj_id": "Player#Q2", "obj_id": "Team#Q1",
         "properties": {"start_year": 2018}},
        {"rid": "1", "label": "playsFor", "subj_id": "Player#QMISSING", "obj_id": "Team#Q1",
         "properties": {}},
    ],
}
...
def test_derive_schema():
    ...
    assert schema.edges["mentors"].roles == {"subj": "subj", "obj": "obj"} or \
        schema.edges["mentors"].roles == {"subj": "person", "obj": "person"}
...
def test_load_and_query(tmp_path):
    ...
    out = execute_read(
        verify(parse('find player where name = "LeBron James" as p\n'
                     "follow p playsFor team as t\nreturn t.name"), schema),
        store, schema, ReadContext())
    assert "Lakers" in out

    # null property dropped, list property joined
    out = execute_read(
        verify(parse('find team where owners contains "Buss" as t\nreturn t.name'), schema),
        store, schema, ReadContext())
    assert "Lakers" in out
